...
| Information | Links |
| :---------- | :-----|
| Calendar Update Status | [![Calendar Update Status](https://github.com/Adam-D-Lewis/butler_events_calendar/actions/workflows/148948811/runs?status=completed&per_page=1)](https://github.com/Adam-D-Lewis/butler_events_calendar/actions/workflows/run_weekly.yaml) |
